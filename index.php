...
<html class="loading">
<head>
	<meta name="author" content="sofoniyas">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">    
    <title>NON SK CHECKER</title>
		...
		<div class="col-md-8">
			<div class="card" style="background-color:transparent;">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong><a href="https://t.me/free_cc_sofi">https://t.me/free_cc_sofi</a></strong></h4>
                    <a  
					style="width:140px;"
					></a>
					</h4>
...
<h5>LIMIT<span class="badge badge-primary float-right">10000</span></h5><hr class="hr-statusbar">
...
Swal.fire({ title: "Warning!", text: "Join our Telegram https://t.me/free_cc_sofi", icon: "warning", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
...
if(total > 10000){
  Swal.fire({title: 'Use less than 10000 cards', icon: 'warning', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
  return false;
}
